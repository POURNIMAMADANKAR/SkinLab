            ...
            <div class="container">
                  ...
                  <div class="header-actions">
                        <button class="header-action-btn">
                              ...
                              <p class="header-action-label"><a href="login.php" style=" overflow: hidden;">
                              <?php 
                                     while ($row=mysqli_fetch_array($rs))
                                    {
                              ?>
            
                                          <b style=" color: #fc9fab; "><?php print($row['name']);?></b><br>
                              <?php
                                    }
                              ?>
                              </a></p>
                        ...
                        <button class="header-action-btn">
                         ...
                         <button class="header-action-btn">
                              <div class="icon-cart">
                                    <ion-icon name="log-out" aria-hidden="true" style=" font-size: 28px; "></ion-icon>         
                                    <p class="header-action-label"><a href="homepage1.php" style=" color: #676464; ">Logout</a></p>   
                              </div> 
                        </button>
